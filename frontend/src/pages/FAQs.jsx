...
//       className="border border-white/20 hover:border-yellow-400/40 rounded-xl overflow-hidden transition-all duration-300 bg-[#F2AF13]/90 backdrop-blur-sm hover:bg-[#F2AF13] group w-[90%] md:w-[80%] self-center"
//     >
//       <button
//         className="w-full flex items-center justify-between p-5 text-left focus:outline-none"
//         onClick={toggleOpen}
//       >
//         <span className={`text-lg font-semibold ${isOpen ? 'text-white' : 'text-white/90 group-hover:text-white'}`}>
//           {question}
//         </span>
//         <span className={`transition-all duration-300 ${isOpen ? 'text-white rotate-180' : 'text-white/70 group-hover:text-white'}`}>
//           <ChevronDown size={20} />
//         </span>
//       </button>
...
//   return (
//     <section id="faq" className="relative overflow-hidden min-h-screen w-full flex items-center justify-center py-20">
//       <div className="container relative z-10 px-4">
//         <div className="text-center max-w-3xl mx-auto mb-12 mt-12">
//           <h2 className="text-4xl md:text-5xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-200">
//             Frequently Asked Questions
//           </h2>
//         </div>

//         <motion.div
//           className="flex w-[90%] flex-col mx-auto space-y-4"
...
//           <p className="text-yellow-100/80 text-lg mb-6">Still have questions?</p>
//           <a
//             href="#contact"
//             className="inline-block px-6 py-2 border-2 border-yellow-400 text-yellow-100 hover:bg-yellow-400/10 rounded-lg transition-all duration-300 hover:border-yellow-300 hover:text-white"
//           >
//             Contact Us
//           </a>
//         </div>
    ...
    <section id="faq" className="relative overflow-hidden min-h-screen w-full flex items-center justify-center py-20 px-4">
      ...
      <div className="container relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-amber-500">
            Frequently Asked Questions
          </h2>
        </div>
