        ...
        <div className="p-8 md:p-12">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-300 text-base md:text-lg max-w-2xl mx-auto">
              Want to connect your Web3 company with top tech talent? Sponsor Assetmerkle IGDTUW to gain high-visibility placement in our campus events and Twitter Spaces.
            </p>
          </div>
