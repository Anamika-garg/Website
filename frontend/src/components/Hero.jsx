          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            <div className="text-center md:text-left flex items-center justify-center flex-col md:block">
              ...
              >
                ...
                <a href="https://www.linkedin.com/company/assetmerkle-igdtuw/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#F6B433] transition-colors duration-300 text-3xl">
                  <FaLinkedin />
                </a>
              </motion.div>
            </div>
