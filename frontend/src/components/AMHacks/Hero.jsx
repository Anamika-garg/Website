...
const AMHacks = () => {
  ...
  useEffect(() => {
    // Update this date if you have a new AM VibeAthon event date
  ...
  return (
    <>
      ...
      <section
        className="relative min-h-screen text-white font-sans overflow-hidden bg-cover bg-center bg-no-repeat"
        style={{
        ...
        <div className="relative z-[2] min-h-screen flex items-center justify-center">
          <div className="container mx-auto px-4 py-16 sm:py-24 relative">
            ...
            >
              ...
              >
                After 1,000+ registrations and 80+
                groundbreaking projects in our first
                edition, AM VibeAthon is back with its 2nd
                edition ready to raise the bar once again.
              </motion.p>
              ...
              */}
              ...
              >
                ...
                <Link to="/register">
                  <motion.span
                    className="inline-flex items-center justify-center bg-gradient-to-r from-yellow-400 to-amber-500 text-black px-8 py-4 rounded-lg font-bold text-lg hover:from-yellow-300 hover:to-amber-400 transition-all duration-300 shadow-lg hover:shadow-xl"
                    whileHover={{
                      scale: 1.05,
                    }}
                    whileTap={{
                ...
                <Link to="/submit">
                  <motion.span
                    className="inline-flex items-center justify-center border-2 border-yellow-400 text-yellow-400 px-8 py-4 rounded-lg font-bold text-lg hover:bg-yellow-400 hover:text-black transition-all duration-300"
                    whileHover={{
                      scale: 1.05,
                    }}
                    whileTap={{
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {galleryImages.map((src, index) => (
            ...
            >
              <img
                src={src}
                alt={`AM VibeAthon event ${index + 1}`}
