...
function AMVibeathonEffect({ className, speed = 1, ...props }) {
  return (
    <div className={cn("relative flex items-center justify-center select-none overflow-visible", className)} {...props}>
      <svg
        viewBox="0 0 500 120"
      ...
      >
        <style>{`
          ...
          .cursive-vibeathon {
            ...
            stroke-dashoffset: 1200;
            animation: draw ${3.2 * speed}s cubic-bezier(0.4, 0, 0.2, 1) forwards;
          }
        `}</style>
        <text
          x="50%"
          ...
          stroke="#fbbf24"
          strokeWidth="1.8"
          className="cursive-vibeathon select-none"
        >
          SheVibes
        </text>
      </svg>
...
export { AppleHelloEnglishEffect, AppleHelloVietnameseEffect, AMVibeathonEffect };
